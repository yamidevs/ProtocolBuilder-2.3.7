package com.ankamagames.dofus.network.messages.game.context.fight
{
   ...
   public class GameFightJoinMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      {
         var _loc2_:uint = 0;
         BooleanByteWrapper.setFlag(_loc2_,0,this.canBeCancelled);
         BooleanByteWrapper.setFlag(_loc2_,1,this.canSayReady);
         BooleanByteWrapper.setFlag(_loc2_,2,this.isSpectator);
         BooleanByteWrapper.setFlag(_loc2_,3,this.isFightStarted);
