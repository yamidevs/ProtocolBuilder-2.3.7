package com.ankamagames.dofus.network.types.game.context.fight
{
   ...
   public class FightOptionsInformations implements INetworkType
   {
      ...
      {
         var _loc2_:uint = 0;
         BooleanByteWrapper.setFlag(_loc2_,0,this.isSecret);
         BooleanByteWrapper.setFlag(_loc2_,1,this.isRestrictedToPartyOnly);
         BooleanByteWrapper.setFlag(_loc2_,2,this.isClosed);
         BooleanByteWrapper.setFlag(_loc2_,3,this.isAskingForHelp);
