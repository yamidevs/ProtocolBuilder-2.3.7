package com.ankamagames.dofus.network.types.game.actions.fight
{
   ...
   public class FightTemporarySpellImmunityEffect extends AbstractFightDispellableEffect implements INetworkType
   {
      ...
      public function initFightTemporarySpellImmunityEffect(param1:uint = 0, param2:int = 0, param3:int = 0, param4:uint = 1, param5:uint = 0, param6:int = 0) : FightTemporarySpellImmunityEffect
      {
         super.initAbstractFightDispellableEffect(param1,param2,param3,param4,param5);
         this.immuneSpellId = param6;
         return this;
      }
