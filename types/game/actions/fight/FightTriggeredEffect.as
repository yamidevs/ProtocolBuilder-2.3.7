package com.ankamagames.dofus.network.types.game.actions.fight
{
   ...
   public class FightTriggeredEffect extends AbstractFightDispellableEffect implements INetworkType
   {
      ...
      public function initFightTriggeredEffect(param1:uint = 0, param2:int = 0, param3:int = 0, param4:uint = 1, param5:uint = 0, param6:int = 0, param7:int = 0, param8:int = 0, param9:int = 0) : FightTriggeredEffect
      {
