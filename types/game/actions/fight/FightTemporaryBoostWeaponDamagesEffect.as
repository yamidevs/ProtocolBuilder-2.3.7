package com.ankamagames.dofus.network.types.game.actions.fight
{
   ...
   public class FightTemporaryBoostWeaponDamagesEffect extends FightTemporaryBoostEffect implements INetworkType
   {
      ...
      public function initFightTemporaryBoostWeaponDamagesEffect(param1:uint = 0, param2:int = 0, param3:int = 0, param4:uint = 1, param5:uint = 0, param6:int = 0, param7:int = 0) : FightTemporaryBoostWeaponDamagesEffect
      {
         super.initFightTemporaryBoostEffect(param1,param2,param3,param4,param5,param6);
         this.weaponTypeId = param7;
         return this;
      }
