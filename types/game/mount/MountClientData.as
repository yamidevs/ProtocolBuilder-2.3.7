package com.ankamagames.dofus.network.types.game.mount
{
   ...
   public class MountClientData implements INetworkType
   {
      ...
      {
         var _loc2_:uint = 0;
         BooleanByteWrapper.setFlag(_loc2_,0,this.sex);
         BooleanByteWrapper.setFlag(_loc2_,1,this.isRideable);
         BooleanByteWrapper.setFlag(_loc2_,2,this.isWild);
         BooleanByteWrapper.setFlag(_loc2_,3,this.isFecondationReady);
