package com.ankamagames.dofus.network.types.game.character.restriction
{
   ...
   public class ActorRestrictionsInformations implements INetworkType
   {
      ...
      {
         var _loc2_:uint = 0;
         BooleanByteWrapper.setFlag(_loc2_,0,this.cantBeAggressed);
         BooleanByteWrapper.setFlag(_loc2_,1,this.cantBeChallenged);
         BooleanByteWrapper.setFlag(_loc2_,2,this.cantTrade);
         BooleanByteWrapper.setFlag(_loc2_,3,this.cantBeAttackedByMutant);
         BooleanByteWrapper.setFlag(_loc2_,4,this.cantRun);
         BooleanByteWrapper.setFlag(_loc2_,5,this.forceSlowWalk);
         BooleanByteWrapper.setFlag(_loc2_,6,this.cantMinimize);
         BooleanByteWrapper.setFlag(_loc2_,7,this.cantMove);
         param1.writeByte(_loc2_);
         var _loc3_:uint = 0;
         BooleanByteWrapper.setFlag(_loc3_,0,this.cantAggress);
         BooleanByteWrapper.setFlag(_loc3_,1,this.cantChallenge);
         BooleanByteWrapper.setFlag(_loc3_,2,this.cantExchange);
         BooleanByteWrapper.setFlag(_loc3_,3,this.cantAttack);
         BooleanByteWrapper.setFlag(_loc3_,4,this.cantChat);
         BooleanByteWrapper.setFlag(_loc3_,5,this.cantBeMerchant);
         BooleanByteWrapper.setFlag(_loc3_,6,this.cantUseObject);
         BooleanByteWrapper.setFlag(_loc3_,7,this.cantUseTaxCollector);
         param1.writeByte(_loc3_);
         var _loc4_:uint = 0;
         BooleanByteWrapper.setFlag(_loc4_,0,this.cantUseInteractive);
         BooleanByteWrapper.setFlag(_loc4_,1,this.cantSpeakToNPC);
         BooleanByteWrapper.setFlag(_loc4_,2,this.cantChangeZone);
         BooleanByteWrapper.setFlag(_loc4_,3,this.cantAttackMonster);
         BooleanByteWrapper.setFlag(_loc4_,4,this.cantWalk8Directions);
